...
const engineType = require("../../../../services/engineType");

class engineTypeController {
    static async engineTypeDetails(req, res) {
        try {
            const response = { data: {}, message: Message.noContent.message, code: Message.noContent.code, extra: {} };
            const srvRes = await engineType.details(req.params._id);
    ...
    static async engineTypeList(req, res) {
        try {
            const response = { data: [], message: Message.noContent.message, code: Message.noContent.code, extra: {} };
            const srvRes = await engineType.list(req.query);
...
module.exports = engineTypeController;