...
const RTOcharge = require("../../../../services/rtoCharge");

class RTOchargeController {
    
    static async rtoChargeList(req, res) {
        try {
            const response = { data: [], message: Message.noContent.message, code: Message.noContent.code, extra: {} };
            const srvRes = await RTOcharge.list(req.query);
...
module.exports = RTOchargeController;