...
class modelVariantController {

    static async variantDetails(req, res) {
        try {
            const response = { data: {}, message: Message.noContent.message, code: Message.noContent.code, extra: {} };
            const srvRes = await modelVariantService.details(req.params._id);
    ...
    static async variantList(req, res) {
        try {
            const response = { data: [], message: Message.noContent.message, code: Message.noContent.code, extra: {} };
            const srvRes = await modelVariantService.list(req.query);
    ...
    static async variantDelete(req, res) {
        try {
            const response = { message: Message.dataDeletionError.message, code: Message.dataDeletionError.code };
            const srvRes = await modelVariantService.delete(req.body.ids);
            if (srvRes.status) {
...
module.exports = modelVariantController;