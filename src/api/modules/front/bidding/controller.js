...
class bidController {
    static async save(req, res) {
        ...
        const requiredFields = [
            'customer_expectation', 'no_of_owners', 'work_needed_manual_report', 'state', 'rto', 'make', 'model', 'variant', 'manufacturing_date',
            'registration_date', 'kms_driven', 'fuel_type', 'rc', 'loan', 'chassing_embossing', 'piece_change_if_any', 'rusting_if_any', 'engine_condition',
            'steering_suspension', 'ac', 'tyres', 'Keys', 'spare_tyre', 'painted', 'insurance', 'insurance_validity', 'transmission_type', 'transmission'
        ];
